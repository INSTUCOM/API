...
HERE;
							...
							print <<<HERE
						<div class="alert alert-danger">An Error occured! <br> ID or email already registered </div>
HERE;
						}
					}
			?>
				...
				<!-- registration form -->
				<form action="registerController" method="post" class="sky-form boxed" novalidate="validate">
					<header><i class="fa fa-users"></i> Create Account</header>
					
					<fieldset>	
						<label class="input">
							<i class="icon-append fa fa-user"></i>
							<input type="text" name="id" placeholder="Identification Number">
							<b class="tooltip tooltip-bottom-right">ID given to you by device</b>
						</label>				
						<label class="input">
