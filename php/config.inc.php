...
define('UPLOAD_FOLDER_URL',	'http://localhost/Smarty/Admin/HTML/php/_upload/');	// Full url path to upload folder (used for contact files) - slash at the end!
define('UPLOAD_MAX_SIZE',	10000000);											// 1000000 = 10Mb

?>C:\xampp\htdocs\Smarty\Admin\HTML\php